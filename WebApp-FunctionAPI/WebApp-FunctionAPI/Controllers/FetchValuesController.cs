...
namespace WebApp_FunctionAPI.Controllers
{
    [Authorize]
    public class FetchValuesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, AzureAdOptions.Settings.APIBaseAddress + "?name=mohit");
